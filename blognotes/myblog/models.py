...
class Post(models.Model):
    ...
    def approve_comments(self):
        ...
        This method filters out unapproved(approved_comment = False) comments
        from Comment class, So that only approved(approved_comment = True)
        comments save to the model 'Post'
        '''
...
class Comment(models.Model):
    ...
    Anyone can put a comment to a post but it need to get approved, an
    approved_comment attribute so added extra to this Comment class
    '''
